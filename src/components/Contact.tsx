...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    { icon: MapPin, text: 'City, Country', href: '#' },
  ...
  return (
    <section ref={sectionRef} id="contact" className="min-h-screen py-20 relative overflow-hidden">
      ...
      <div className={`container mx-auto px-6 relative z-10 transition-all duration-1000 ${
        ...
        <h2 className="text-5xl font-bold mb-12 text-center glitch-text">Contact Me</h2>
